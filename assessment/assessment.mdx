...
**Versioning.** This is method v0.6. It adds the subject, scale, and custody boundary; treats subject and custodian as relational roles that can recur across levels; extends custody seats to collective orchestration; and prevents replicated evidence or member standing from being counted as collective standing. The three-reading architecture, protected object, territories, dimensions, no-composite rule, and evidence standards are unchanged. Validation gate status: Gate A (usability) cleared at the AI-evaluator bar, the standing usability bar across instrument validation gates during the active building phase; Gate B (empirical) cleared with the first record. The Meridian Council, on activation, can revisit the AI-evaluator standard.
