...
<span id="part-1-finding" className="section-anchor" />
...
<span id="agentic-assurance" className="section-anchor" />
...
<span id="claim-ceiling" className="section-anchor" />
...
<SourceGroup title="Method and evaluator record">
  <Source href="/assessment/method">AI Model Assessment method v0.8</Source>
...
<span id="evidence-weighting" className="section-anchor" />
