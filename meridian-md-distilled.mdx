...
*Step 1 of the Implementation depth ladder. Companion to the [Implementation page](/implementation), [MERIDIAN.md](/meridian-md), and [MERIDIAN.implementation.md](/meridian-implementation). Distilled from MERIDIAN.md v0.9.5.*
