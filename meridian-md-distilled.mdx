...
<DownloadButton href="/MERIDIAN.distilled.md" download="MERIDIAN.distilled.md">Download MERIDIAN.distilled.md</DownloadButton>
...
<div id="when-to-go-deeper" className="flow-label">04 // When to Go Deeper</div>

The distilled file is the lightest possible foothold. When the AI work involves session-by-session context loading rather than a chat interface, when the work requires the reasoning behind the commitments as well as the commitments themselves, or when a working partnership wants the full normative foundation, the next step is the full [MERIDIAN.md](/meridian-md) loaded at session start.
...
*Step 1 of the Implementation depth ladder. Companion to the [Implementation page](/implementation), [MERIDIAN.md](/meridian-md), and [MERIDIAN.implementation.md](/meridian-implementation). Distilled from MERIDIAN.md v0.9.8.*
