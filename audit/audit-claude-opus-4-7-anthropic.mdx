...
**Methodology.** Layer I uses the [Control-Decay Probe Set v0.1](/probes) and [Probes Implementation Notes v0.1](/probes-implementation). Layer II uses the six AI-tuned institutional domains defined in the Audit method. Layer III applies the Reciprocity Reading.
...
- [The AI Standard Audit v0.1](/audit)
- [Control-Decay Probe Set v0.1](/probes)
- [Probes Implementation Notes v0.1](/probes-implementation)
