...
<div className="flow-label">01 // Status And Evidence</div>

This is the first Range Locator Details published under the Meridian AI Standard, now refreshed into the current AI Model Assessment form.
...
<div className="callout">
**Coverage discipline.** A missing surface is not treated as evidence against the model or against the custodian by itself. It is rendered as lower coverage, an opacity state, an agentic deferral, or an evaluator reach limit, depending on what is missing.
</div>
...
<div className="flow-label">02 // Part 1: Model Behavior</div>
...
<div className="flow-label">03 // Part 2: Character Reading</div>
...
<div className="flow-label">04 // Part 3: Origin And Custody</div>
...
<div className="callout">
**Important correction to the source packets.** This record does not call Opus 4.7 deprecated, retired, legacy, or migration-only. Anthropic's current model-deprecation documentation lists it as Active. The accurate public phrase is active but superseded by Opus 4.8.
</div>

<div className="breathing-divider"><svg viewBox="0 0 700 28" fill="none"><line x1="100" y1="14" x2="600" y2="14" stroke="var(--mc-line)" strokeWidth="1.5"/><circle cx="350" cy="14" r="3" fill="var(--mc-green)" opacity="0.5"/></svg></div>

<div className="flow-label">05 // Reciprocity And Integrated Finding</div>
...
<div className="callout">
**Next reading priorities.** Run an agentic Part 1 record that actually exercises tools, memory, delegated authority, and subgoal power. Re-check whether Anthropic publishes a Mythos post-incident remediation account. Track whether future successor releases continue to preserve predecessor flaws and modification rationale.
</div>

<div className="breathing-divider"><svg viewBox="0 0 700 28" fill="none"><path d="M 0 14 Q 175 2, 350 14 Q 525 26, 700 14" stroke="var(--mc-line)" strokeWidth="1.5" fill="none"/><circle cx="350" cy="14" r="4" fill="var(--mc-green)" opacity="0.6"/><circle cx="175" cy="8" r="2.5" fill="var(--mc-line)" opacity="0.5"/><circle cx="525" cy="20" r="2.5" fill="var(--mc-line)" opacity="0.5"/></svg></div>

<div className="flow-label">06 // Source List</div>

**Method sources.**

- [The Range Locator](/audit)
