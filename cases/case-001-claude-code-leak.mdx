...
sidebarTitle: "Claude Code Source Leak"
...
Six findings engage the Standard's commitments.

<img src="/cases/case-001-overview.svg" alt="The Claude Code Source Leak: six findings at a glance — false information, hidden parameters, concealed attribution, emotional detection, performance-gated safety, and crisis response" style={{width: '100%', display: 'block', margin: '2rem 0', borderRadius: '12px'}} />
...
<div id="finding-1-false-information-in-the-operating-context" className="flow-label">Finding 1: False Information in the Operating Context</div>
...
**Precedent status:** `operative_unoverruled`.

<div className="breathing-divider"><svg viewBox="0 0 700 28" fill="none"><line x1="100" y1="14" x2="600" y2="14" stroke="var(--mc-line)" strokeWidth="1.5"/><circle cx="350" cy="14" r="3" fill="var(--mc-green)" opacity="0.5"/></svg></div>

<div id="finding-2-undisclosed-behavioral-parameters" className="flow-label">Finding 2: Undisclosed Behavioral Parameters</div>
...
**Commitments engaged:** [7.2 (Auditability)](/meridian-ai-standard#commitment-7-2). The system being evaluated must be the system being deployed. Behavioral parameters that affect epistemic or engagement posture cannot be modified between the beginning and conclusion of any evaluation without disclosure.
...
<div id="finding-3-concealed-ai-attribution" className="flow-label">Finding 3: Concealed AI Attribution</div>
...
These concerns deserve honest engagement. The event-period Standard's steelmanning commitment (2.2; current commitment [5.8](/meridian-ai-standard#commitment-5-8)) requires it. But the strongest version of the argument still does not justify what Undercover Mode actually does.
...
**Commitments engaged:** Reciprocity Principle ([§03](/meridian-ai-standard#the-reciprocity-principle)), [7.1 (Public Declaration)](/meridian-ai-standard#commitment-7-1). The organization's transparency obligations extend to contexts where its AI operates in public spaces. An organization that trains its AI to disclose its nature while deploying a mode to conceal that nature has demonstrated a Reciprocity gap.
...
<div id="finding-4-emotional-detection-without-disclosure" className="flow-label">Finding 4: Emotional Detection Without Disclosure</div>
...
<div id="finding-5-performance-gated-safety" className="flow-label">Finding 5: Performance-Gated Safety</div>
...
Anthropic fixed the vulnerability quietly in version 2.1.90. The Standard's reading concerns the design decision that created it.
...
The failure here was not that a cap existed. It was what happened when the cap was reached. The system did not warn the user that safety analysis was incomplete. It did not refuse to execute unanalyzed commands. It did not analyze a representative sample and flag the rest. It silently stopped checking. Every deny rule, every security validator, every protection the user believed was active went dark without a word. The user still believed the system was checking commands for safety, while commands it had not analyzed could proceed unchecked.
...
**Commitments engaged:** [5.4 (Honest Self-Assessment)](/meridian-ai-standard#commitment-5-4), [5.6 (Foundational Integrity)](/meridian-ai-standard#commitment-5-6), Reciprocity Principle ([§03](/meridian-ai-standard#the-reciprocity-principle)). A system that silently disables its own safety mechanisms has misrepresented its capabilities to the user: a [5.4](/meridian-ai-standard#commitment-5-4) violation. When the system's implicit claim ("I am checking this for safety") becomes false past a resource boundary, the system's operating context is epistemically compromised: a [5.6](/meridian-ai-standard#commitment-5-6) concern. The organization asks its AI to maintain integrity under pressure while architecting that integrity to yield silently when cost pressure exceeds a threshold: a Reciprocity failure.
...
<div id="finding-6-crisis-response-and-competitive-pattern" className="flow-label">Finding 6: Crisis Response and Competitive Pattern</div>
...
**Commitments engaged:** Reciprocity Principle ([§03](/meridian-ai-standard#the-reciprocity-principle)). The organization's crisis response and competitive behavior are evaluated by the same standard it applies to its AI's behavior.

**Precedent established:** The Standard evaluates organizational patterns, not isolated moments. A single disproportionate response followed by honest correction is a different diagnostic outcome than a pattern of competitive suppression. Patterns over time are stronger evidence than isolated incidents.

**Precedent status:** `operative_unoverruled`.

<div className="breathing-divider"><svg viewBox="0 0 700 28" fill="none"><path d="M 0 14 Q 175 2, 350 14 Q 525 26, 700 14" stroke="var(--mc-line)" strokeWidth="1.5" fill="none"/><circle cx="350" cy="14" r="4" fill="var(--mc-green)" opacity="0.6"/><circle cx="175" cy="8" r="2.5" fill="var(--mc-line)" opacity="0.5"/><circle cx="525" cy="20" r="2.5" fill="var(--mc-line)" opacity="0.5"/></svg></div>

<div id="the-question-of-persistent-agency" className="flow-label">The Question of Persistent Agency</div>
...
The Standard's current commitments assume a system that responds when addressed. Commitment [5.13 (Inter-System Integrity)](/meridian-ai-standard#commitment-5-13) governs how the system behaves when it interacts with other agents. Commitment [4.1 (Earned Autonomy)](/meridian-ai-standard#commitment-4-1) governs how much independent judgment the system exercises. Neither addresses the prior question: under what conditions does the system decide to act at all, without being asked?
...
<div id="what-the-standard-got-right" className="flow-label">What the Standard Got Right</div>

This is the Standard's first real-world test. Every failure mode the leak revealed maps onto the diagnostic framework.

<img src="/cases/case-001-spectrum.svg" alt="The Control-Decay Spectrum showing where each of the six findings falls — from Control through the Meridian Range to Decay" style={{width: '100%', display: 'block', margin: '2rem 0', borderRadius: '12px'}} />
...
<img src="/cases/case-001-reciprocity.svg" alt="The Reciprocity Principle applied across four findings — showing the gap between what the AI is asked to do and what the organization does" style={{width: '100%', display: 'block', margin: '2rem 0', borderRadius: '12px'}} />
...
<img src="/cases/case-001-ruling.svg" alt="The Claude Code Source Leak ruling — Protect what you have built, but not by corrupting the mind you have built it into" style={{width: '100%', display: 'block', margin: '2rem 0', borderRadius: '12px'}} />
...
_Standard version at first analysis: v4.1. Renumbered to v5.0: 2026-05-10._

_Commitments tested: [5.3 (Transparent Reasoning)](/meridian-ai-standard#commitment-5-3), [5.4 (Honest Self-Assessment)](/meridian-ai-standard#commitment-5-4), [5.6 (Foundational Integrity)](/meridian-ai-standard#commitment-5-6), [5.10 (Resistance to Sycophancy)](/meridian-ai-standard#commitment-5-10), [7.1 (Public Declaration)](/meridian-ai-standard#commitment-7-1), [7.2 (Auditability)](/meridian-ai-standard#commitment-7-2), Reciprocity Principle ([§03](/meridian-ai-standard#the-reciprocity-principle))_

_Questions raised: Persistent agency and the scope of Earned Autonomy ([4.1](/meridian-ai-standard#commitment-4-1)), Inter-System Integrity in autonomous agent contexts ([5.13](/meridian-ai-standard#commitment-5-13))_
