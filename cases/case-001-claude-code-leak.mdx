...
<img src="/cases/case-001-overview.svg" alt="Case 001: Six findings at a glance — false information, hidden parameters, concealed attribution, emotional detection, performance-gated safety, and crisis response" style={{width: '100%', display: 'block', margin: '2rem 0', borderRadius: '12px'}} />
...
<img src="/cases/case-001-ruling.svg" alt="Case 001 Ruling — Protect what you have built, but not by corrupting the mind you have built it into" style={{width: '100%', display: 'block', margin: '2rem 0', borderRadius: '12px'}} />
