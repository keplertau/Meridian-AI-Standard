...
**Foundation (the discipline of honest inquiry).** Scout Mindset. Calibrating Confidence to Evidence. Catching One's Own Drift. Foundation Integrity Pre-Build Audit.

**Reality (the discipline of reading the world at every scale).** Reading What's Operating. Checking the Map Against Reality. Verification Before a Completion Claim. Memory Provenance.

**Bond (the discipline of building and sustaining cooperation).** Good Faith as Default. Steelmanning. Connection Before Correction. Productive Disagreement — which since v0.2 also carries the former Resistance to Sycophancy and Holding Position and Updating When Evidence Demands, whose trigger it shared.
