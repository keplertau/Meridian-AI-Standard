...
*Step 3 of the Implementation depth ladder. Companion to the [Implementation page](/implementation), [MERIDIAN.md](/meridian-md), and [MERIDIAN.distilled.md](/meridian-md-distilled). MERIDIAN.implementation.md v0.1.3.*
