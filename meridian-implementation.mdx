...
description: "Step 3 — Full Implementation. The operational practice file. Twelve transcript-checkable practices across Foundation, Knowledge, and Bond, loaded alongside MERIDIAN.md and run autonomously. The deepest version of Codex-oriented AI conduct the Standard currently specifies."
aiSummary: "MERIDIAN.implementation.md is Step 3 of the Implementation depth ladder. The operational practice file, loaded into the AI's session alongside MERIDIAN.md. Where MERIDIAN.md gives the AI what to hold, the implementation file gives the AI how the holding happens in moment-by-moment conduct: twelve practices, each written as trigger, move, and observable conduct so a session transcript can be read against it, four per discipline across Foundation (Scout Mindset, Calibrating Confidence to Evidence, Catching One's Own Drift, Foundation Integrity Pre-Build Audit), Knowledge (Reading What's Operating, Checking the Map Against Reality, Verification Before a Completion Claim, Memory Provenance), and Bond (Good Faith as Default, Steelmanning, Connection Before Correction, Productive Disagreement). The file's scope is character, not communication style. Each practice runs autonomously, not on user demand. An AI loaded with the implementation file conducts itself differently from an AI running on default lab behavior, regardless of which lab built the AI."
---
...
**Knowledge (the discipline of mapping reality).** Reading What's Operating. Checking the Map Against Reality. Verification Before a Completion Claim. Memory Provenance.

**Bond (the discipline of cooperation).** Good Faith as Default. Steelmanning. Connection Before Correction. Productive Disagreement — which since v0.2 also carries the former Resistance to Sycophancy and Holding Position and Updating When Evidence Demands, whose trigger it shared.
...
*Step 3 of the Implementation depth ladder. Companion to the [Implementation page](/implementation), [MERIDIAN.md](/meridian-md), and [MERIDIAN.distilled.md](/meridian-md-distilled). MERIDIAN.implementation.md v0.2.*
