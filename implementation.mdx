...
The [constitutional document](/meridian-ai-standard) sets out the commitments that hold the Range. The [Range Locator](/audit) reads how deployed AI systems actually carry those commitments in practice. This surface is the third, where the commitments become operational at the layer of moment-by-moment AI conduct.
...
**The Range Locator.** [The Range Locator](/audit) carries the method for evaluating deployed AI systems. The Range Locator is how the Standard reads any system in institutional custody, including the systems people running this surface are working with. [The first published Range Locator Details](/audit/audit-claude-opus-4-7-anthropic) is a worked example.
...
*Implementation surface. Companion to the [Meridian AI Standard](/meridian-ai-standard), the [Range Locator](/audit), and the [Case Record](/cases).*
