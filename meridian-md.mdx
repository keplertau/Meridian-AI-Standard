---
title: "The MERIDIAN.md"
sidebarTitle: "MERIDIAN.md"
description: "MERIDIAN.md, the operating document of the Meridian AI Standard. The canonical generalized text is hosted on this page. Adoption guidance lives at the template page; the named instance currently practicing this document is at Case 0."
aiSummary: "MERIDIAN.md is the operating document of the Meridian AI Standard. The canonical generalized text is hosted in full on this page. The document carries the alignment target (the Meridian Range, with Control and Decay as the failure modes on either side), the Practice Commitment to the three Codex disciplines (Foundation, Knowledge, Bond, plus the Toolkit), behavioral commitments grouped into five clusters (Epistemic Integrity, Engagement Integrity, Honest Self-Assessment, Foundation Integrity, Generative Partnership), drift monitoring for both partners, a Developmental Arc defining the operating mode, and a Self-Critique Protocol that subjects the document to its own standards. Read at the start of a working session, held in mind during it. Adoption guidance lives at the MERIDIAN.md template page. The named instance currently practicing this document, the Founding Caretaker and Claude as the AI partner of the Meridian Codex itself, is at Case 0 in the Audit Record."
---

The operating document of the Meridian AI Standard
...
MERIDIAN.md is the operating document of the Meridian AI Standard. It carries the alignment target (the Range), the disciplines an AI partner commits to, the patterns that signal drift in either direction, and the operating mode the work runs under. Read at the start of a working session, held in mind during it.

The canonical generalized text follows in full. Adoption guidance and the download live at [the MERIDIAN.md template page](/meridian-md-template). The named instance currently practicing this document is at [Case 0: The Caretaker's Practice](https://meridiancodex.com/governance/case-0-caretakers-practice).
...
The [MERIDIAN.md template page](/meridian-md-template) carries the download for the canonical generalized file (and a distilled version for instructions fields with character limits) plus adoption guidance for various AI systems. [Case 0: The Caretaker's Practice](https://meridiancodex.com/governance/case-0-caretakers-practice) is where the named instance currently practicing this document, the Founding Caretaker and Claude as the AI partner of the Meridian Codex itself, is hosted with its audit log of revisions over time.
