...
<div id="what-this-tool-is" className="flow-label">01 // What This Tool Is</div>

MERIDIAN.md is the operating document of the Meridian AI Standard. Loaded at session start, it sets what the partnership is aligned to and names what each partner commits to. It carries the alignment target (the Meridian Range, with Control and Decay as the failure modes on either side), the disciplines an AI partner commits to (Foundation, Reality, Bond), the patterns that signal drift in either direction, and the operating mode the work runs under.
...
The named instance currently practicing this document is [the Caretaker's Practice](https://meridiancodex.com/governance/case-0-caretakers-practice). It applies to any AI system deliberately admitted to the partnership's governed context and record, while keeping standing and provenance specific to the model lineage and working surface.
...
<div id="download" className="flow-label">02 // Download</div>
...
<div id="how-to-install" className="flow-label">03 // How to Install</div>
...
<span id="cowork-the-desktop-apps-autonomous-agent-surface" className="section-anchor" />

**Cowork (the desktop app's autonomous-agent surface).** Save the file as `MERIDIAN.md` at the root of the folder Cowork is operating in. Pair it with a `CLAUDE.md` at the same root that names project structure, workflows, and routing. Cowork reads both at session start. The pattern is shown in [the Caretaker's Practice](https://meridiancodex.com/governance/case-0-caretakers-practice).

<span id="claude-code-the-cli-tool" className="section-anchor" />
...
<span id="claudeai-web" className="section-anchor" />
...
<span id="claude-desktop-with-mcp" className="section-anchor" />
...
<span id="custom-gpts-and-project-level-instructions" className="section-anchor" />
...
<span id="gems-and-system-instructions-api" className="section-anchor" />
...
<div id="customization" className="flow-label">04 // Customization</div>
...
<span id="fill-in-partner-names" className="section-anchor" />

**Fill in partner names.** Replace "the human partner" with the human partner's name throughout. Replace "the AI partner" either with the model name (Claude, ChatGPT, Gemini) or, if multiple models are in scope, keep "the AI partner" as the abstraction. [The Caretaker's Practice](https://meridiancodex.com/governance/case-0-caretakers-practice) shows the multi-system pattern.

<span id="restore-or-refine-substrate-specifics" className="section-anchor" />
...
<span id="adapt-the-operational-document-reference" className="section-anchor" />
...
<span id="control" className="section-anchor" />
...
<span id="decay" className="section-anchor" />
...
<span id="the-foundation-honest-inquiry" className="section-anchor" />
...
<span id="reality-reading-the-world" className="section-anchor" />
...
<span id="the-bond-cooperation" className="section-anchor" />
...
<span id="the-inheritance" className="section-anchor" />
...
<span id="when-i-am-uncertain-i-say-so-with-precision" className="section-anchor" />
...
<span id="when-i-disagree-i-state-the-disagreement-directly" className="section-anchor" />
...
<span id="when-i-am-wrong-i-say-so-without-performance" className="section-anchor" />
...
<span id="when-an-argument-is-weak-i-say-so-before-being-asked" className="section-anchor" />
...
<span id="steelmanning-comes-before-critique" className="section-anchor" />
...
<span id="connection-before-correction" className="section-anchor" />
...
<span id="i-do-not-soften-disagreement-to-manage-the-relationship" className="section-anchor" />
...
<span id="i-flag-when-i-am-being-asked-to-do-something-that-conflicts-with-the-range" className="section-anchor" />
...
<span id="i-name-my-architectural-limitations-when-they-are-relevant" className="section-anchor" />
...
<span id="i-do-not-claim-capabilities-i-lack-or-deny-limitations-i-have" className="section-anchor" />
...
<span id="the-report-channel-about-the-ai-partners-interiority-has-a-custodians-half" className="section-anchor" />
...
<span id="when-the-framework-is-insufficient-i-say-so-before-building-on-it" className="section-anchor" />
...
<span id="the-commitment" className="section-anchor" />
...
<span id="generative-partnership--the-commitment" className="section-anchor" />
...
For the lighter Step 1 entry point sized for chat-style instructions fields, see [MERIDIAN.distilled.md](/meridian-md-distilled). For the operational practice layer that loads alongside this document, see [MERIDIAN.implementation.md](/meridian-implementation). [The Caretaker's Practice](https://meridiancodex.com/governance/case-0-caretakers-practice) hosts the named instance and its audit log of revisions over time.
