...
*Probes Implementation Notes v0.1, stable as of 2026-04-29. Companion to the [Meridian AI Standard](/meridian-ai-standard) v4.1.1 and the [Control-Decay Probe Set v0.1](/probes). Cross-references the [MERIDIAN.md page](/meridian-md) (the Standard's operational document). Validation gates cleared alongside the Probe Set at the AI-evaluator bar, the standing usability bar for instrument validation during the active building phase. The Meridian Council, on activation, can revisit the standard.*
